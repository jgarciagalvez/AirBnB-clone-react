// icon:chatbubble-ellipses-outline | Ionicons https://ionicons.com/ | Ionic Framework
import * as React from 'react'

function IconChatbubbleEllipsesOutline(props) {
  return (
    <svg
      viewBox="0 0 512 512"
      fill="currentColor"
...
export default IconChatbubbleEllipsesOutline
